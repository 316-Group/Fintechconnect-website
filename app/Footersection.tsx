...
export default function FooterSection() {
  ...
  const footerNavigation = {
    ...
    solutions: [
      { name: 'Retail Banking', href: '#' },
      { name: 'Business Banking', href: '#' },
      { name: 'Digital Wallets', href: '#' },
      { name: 'Mobile Money wallets', href: '#' },
      { name: 'Payments', href: '#' },
      { name: 'Lending & Investment', href: '#' },
    ],
    whoWeServe: [
      { name: 'Banks', href: '#' },
      { name: 'Credit Unions', href: '#' },
      { name: 'Fintechs', href: '#' },
      { name: 'Mobile Wallet Operators', href: '#' },
      { name: 'Remittance Companies', href: '#' },
      { name: 'Lenders', href: '#' },
      { name: 'Private Banks', href: '#' },
      { name: 'Payment Gateway Providers', href: '#' },
    ],
    helpSupport: [
      { name: 'Contact', href: '#' },
      ...
      <div className="max-w-full pl:6 md:pl-10 mx-auto ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-6 pb-16 pl-6 md:pl-16 md:pr-10">
          ...
          <div className="lg:col-span-2 flex flex-col items-start justify-between min-h-[140px]">
            <div>
              {/* Logo */}
        <svg width="150" height="50" viewBox="0 0 654 201" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect width="7.24888" height="52.7191" rx="3.62444" transform="matrix(0.999533 -0.0305672 -0.0305672 -0.999533 248.223 200.014)" fill="#0A63F8"/>
              ...
              {/* Tiny Affiliation Subtext */}
              <span className="text-[11px] text-slate-400 block tracking-wide mb-6">
                By 316 Group
              </span>
            </div>

            {/* Support Email Link anchor */}
            <a 
              href="mailto:contact@316group.co.uk" 
              className="text-xs text-slate-300 hover:text-[#0066ff] transition-colors duration-200 tracking-wide mt-auto"
            >
              contact@316group.co.uk
            </a>
          </div>
          ...
          {/* Column 4: Market Segments Demographics */}
          <div className="flex flex-col space-y-4">
            <h3 className="text-base lg:text-lg font-medium text-white tracking-wide">
              Who we serve
            </h3>
            <ul className="space-y-3">
              {footerNavigation.whoWeServe.map((item) => (
                <li key={item.name}>
                  <a href={item.href} className="text-sm text-slate-300 hover:text-[#0066ff] font-light transition-colors duration-200 block">
                    {item.name}
                  </a>
        ...
        {/* Bottom Area Separator Divider Line */}
        <div className="border-t border-white/10 pt-8 mt-4 flex flex-col items-center justify-center">
          <p className="text-center text-xs sm:text-sm text-slate-300 font-light tracking-wide leading-relaxed">
            2023 316 Group. All rights reserved |{' '}
            <a href="#" className="hover:text-[#0066ff] transition-colors duration-200">
              Policy.
            </a>
          </p>
        </div>
