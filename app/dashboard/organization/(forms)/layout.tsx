...
const ONBOARDING_STEPS = [
  ...
  },
  {
    id: 6,
    title: "Review",
    href: "/dashboard/organization/review",
  },
];
    ...
    <div className="dashboard-scope min-h-screen bg-[#F8FAFC] flex flex-col font-sans text-slate-800">
      ...
      <header className="h-16 bg-white border-b border-slate-200 px-8 flex items-center justify-between sticky top-0 z-30">
        ...
        <div className="flex items-center gap-4 text-slate-500">
          ...
          <div className="w-8 h-8 rounded-full bg-slate-300 overflow-hidden border border-slate-200 ml-1">
            <img
      ...
      {/* Main Container */}
      <div className="flex-1 max-w-full w-full mx-auto px-20 py-8 flex gap-12">
        {/* Sidebar */}
