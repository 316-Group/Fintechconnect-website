      ...
      <main className="flex-1 p-8 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-6">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-bold text-slate-700">Legal Company Name</label>
            <input
              type="text"
              name="legalName"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-700">Company Registration Number</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-700">Country of Incorporation</label>
