...
export default function DashboardPage() {
  ...
  // Calculate Overall KYB Progress dynamically
  ...
  const navItems = [
    ...
    { name: "Verification & KYB", icon: FileCheck2 },
    { name: "Beneficial Ownership", icon: Users2 },
  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC] font-sans text-slate-800">
      ...
      <aside className="w-64 border-r border-slate-200 bg-white flex flex-col justify-between shrink-0">
          ...
          <div className="flex items-center gap-2.5 pl-0 pr-4 py-5 border-b border-slate-100">
            ...
            >
              ...
              <rect
                ...
                height="52.7191"
                rx="3.62444"
                transform="matrix(-0.999793 -0.0203619 -0.0203619 0.999793 253.736 21.9693)"
                fill="#0A63F8"
              />
              <rect
                width="7.24888"
                height="52.7191"
                rx="3.62444"
                transform="matrix(-0.849868 -0.526995 -0.526995 0.849868 302.125 28.4821)"
                fill="#0A63F8"
              />
              <rect
                width="7.24888"
                height="52.7191"
                rx="3.62444"
                transform="matrix(-0.480664 -0.876905 -0.876905 0.480664 337.863 59.1159)"
                fill="#0A63F8"
              />
              <rect
                width="7.24888"
                height="52.7191"
                rx="3.62444"
                transform="matrix(0.503146 -0.864202 -0.864202 -0.503146 346.105 149.786)"
                fill="#0A63F8"
              />
              <rect
                width="7.24888"
                height="52.7191"
                rx="3.62444"
                transform="matrix(0.721529 -0.692385 -0.692385 -0.721529 324.629 178.293)"
                fill="#0A63F8"
              />
              <rect
                width="7.24888"
                height="52.7191"
                rx="3.62444"
                transform="matrix(0.900044 -0.435799 -0.435799 -0.900044 288.037 194.412)"
                fill="#0A63F8"
              />
              <rect
                width="7.24888"
                height="52.7191"
                rx="3.62444"
                transform="matrix(0.999533 -0.0305672 -0.0305672 -0.999533 248.223 200.014)"
                fill="#0A63F8"
              />
            </svg>
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isDisabled && <Lock className="w-3.5 h-3.5 text-slate-400" />}
                </button>
              );
            })}
          </nav>
        ...
        {/* Sidebar Footer / Dynamic Progress Box */}
        <div className="p-4 space-y-3">
          <button className="w-full py-2.5 bg-slate-900 text-white font-medium text-xs rounded-lg hover:bg-slate-800 transition-colors shadow-sm">
            Save Progress
          </button>

          <div className="p-3.5 bg-slate-100 rounded-xl space-y-2">
            ...
            <div className="max-w-2xl space-y-4">
              ...
              <div className="pt-2 space-y-2 max-w-lg">
                <div className="flex justify-between text-xs font-semibold">
                  <span>Step Completion Progress</span>
                  <span>{activeStep.progress}%</span>
                </div>
                <div className="w-full bg-blue-900/40 h-2 rounded-full overflow-hidden backdrop-blur-sm">
                  <div
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Review and manage your institutional onboarding stages.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <div className="p-6 bg-white border border-slate-200/80 rounded-xl flex flex-col justify-between space-y-6 hover:shadow-sm transition-all">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <span className="text-xs font-mono text-blue-600">v2.4.0</span>
                </div>
              </div>
              ...
              <div className="p-6 bg-white border border-slate-200/80 rounded-xl flex flex-col justify-between space-y-6 hover:shadow-sm transition-all">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <span className="text-xs font-mono text-blue-600">v3.1.2</span>
                </div>
              </div>
              ...
              <div className="p-6 bg-white border border-slate-200/80 rounded-xl flex flex-col justify-between space-y-6 hover:shadow-sm transition-all">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2.5 py-0.5 bg-slate-100 text-slate-500 rounded-full text-[10px] font-bold tracking-wider">
                      AVAILABLE
                    </span>
                  </div>
                  <div>
              ...
              <div className="p-6 bg-white border border-slate-200/80 rounded-xl flex flex-col justify-between space-y-6 hover:shadow-sm transition-all">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <span className="text-xs font-mono text-blue-600">v1.9.0</span>
                </div>
              </div>
              ...
              <div className="p-6 bg-blue-600 rounded-xl flex flex-col justify-between space-y-6 shadow-md transition-all text-white">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2.5 py-0.5 bg-blue-500/50 text-white rounded-full text-[10px] font-bold tracking-wider">
                      POPULAR
                    </span>
                  </div>
                  <div>
