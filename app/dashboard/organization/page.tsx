...
import {BookOpen, BadgeCheck, CreditCard, } from "lucide-react";
import { Boxes, Clock, Workflow, TrendingUp, Sliders } from "lucide-react";
  ...
  const checklistCards = [
    {
      ...
      description: "Basic entity details and registration country",
      icon: Building2,
      active: true,
      progress: 25,
    },
    {
      ...
      description: "Tax identification and FATCA/CRS declarations",
      icon: ShieldCheck,
      active: false,
    },
    {
    ...
    },
    {
      ...
      description: "High-resolution certificates and proof of address",
      icon: FolderClosed,
      active: false,
    },
  ];
          ...
          <section className="bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-600 rounded-2xl p-7 text-white shadow-lg shadow-blue-500/10 relative overflow-hidden">
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-sm text-blue-100 leading-relaxed max-w-xl">
                Your business entity verification is incomplete. Complete the
                remaining steps to unlock full institutional trading features and
              ...
              <div className="pt-2 space-y-2 max-w-lg">
                ...
                <div className="w-full bg-blue-900/40 h-2 rounded-full overflow-hidden backdrop-blur-sm">
                  <div className="bg-emerald-400 h-full w-1/4 rounded-full transition-all duration-500" />
                </div>
              </div>
            </div>
...
<section className="space-y-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    {/* AML Engine Card (Featured/Popular) */}
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 leading-relaxed">
            ...
            baked into every module. Stay compliant globally without the manual
            overhead.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              ...
              core banking system (AS/400, SAP, Oracle) via our secure,
              high-performance middleware adapters.
            </p>
          </div>
        </div>
      </div>
...
<div className="space-y-12 pt-6">
  {/* Pre-integrated Connectors Section */}
  <section className="space-y-6">
