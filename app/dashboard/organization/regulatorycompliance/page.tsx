  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC] text-slate-800 font-sans">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col justify-between p-4 shrink-0">
        <div>
          ...
          <nav className="space-y-1 mt-4">
            <a href="/dashboard/organization/businessidentity" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-50 font-medium text-sm transition-colors">
              <Building2 className="w-4 h-4" />
              Organization
            </a>
            {/* Compliance link highlighted */}
            <a href="/dashboard/organization/regulatorycompliance" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-blue-50 text-blue-600 font-medium text-sm">
        ...
        <div className="space-y-3">
          <button className="w-full bg-[#111827] hover:bg-slate-800 text-white font-medium py-2.5 rounded-lg text-sm transition-colors">
            Save Progress
          </button>
      ...
      <main className="flex-1 p-8 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
          <div className="flex items-center justify-between relative px-2">
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[9px] font-bold text-blue-600 mt-1.5 uppercase tracking-wider">Organization</span>
            </div>
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[9px] font-bold text-blue-600 mt-1.5 uppercase tracking-wider">Compliance</span>
            </div>
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[9px] font-bold text-slate-300 mt-1.5 uppercase tracking-wider">Verification</span>
            </div>
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[9px] font-bold text-slate-300 mt-1.5 uppercase tracking-wider">Ownership</span>
            </div>
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[9px] font-bold text-slate-300 mt-1.5 uppercase tracking-wider">Documents</span>
            </div>
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[9px] font-bold text-slate-300 mt-1.5 uppercase tracking-wider">Review</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm space-y-6">
          ...
          <div className="space-y-2.5">
            ...
            <div className="border border-slate-200 rounded-xl p-3 bg-[#F8FAFC] space-y-3">
              ...
              {/* Tag Badges List - Only visible once user has selected countries */}
          ...
          {/* Regulatory Compliance Callout Box */}
        ...
        <div className="flex justify-center items-center gap-6 pt-2 pb-6 text-xs font-medium text-blue-600">
