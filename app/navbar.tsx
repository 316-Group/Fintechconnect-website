    ...
    <header className="sticky top-0 z-50 bg-black shadow-md">
      <nav className="flex items-center justify-between w-full pl-6 lg:pl-20 pr-6 lg:pr-10 py-4">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link 
            href="/signin" 
            className="text-white hover:text-blue-300 font-medium text-sm transition"
          >
            Sign In
          </Link>
          <Link 
          ...
          <div className="flex flex-col p-6 gap-4">
            ...
            <div className="mt-6 flex flex-col gap-3">
              <Link 
                href="/signin" 
                onClick={() => setMobileMenuOpen(false)}
                className="border border-slate-700 hover:bg-slate-900 text-white px-5 py-3 rounded-full font-medium w-full text-sm transition-colors text-center"
              >
                Sign In
              </Link>
              <Link 
