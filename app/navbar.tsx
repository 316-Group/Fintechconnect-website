...
export default function Navbar() {
  ...
  const platformModules: Record<string, { title: string; description: string }[]> = {
    "Core Infrastructure": [
      {
        title: "Core Banking Engine",
        description: "Production-ready banking core with multi-currency accounts, automated payments, and global rail connectivity"
      },
      {
        title: "Real-Time Ledger",
        description: "Record every transaction with precision and immutable audit trails. Stay accurate, compliant, and audit-ready."
      },
      {
        title: "Treasury Management",
        description: "Monitor cash, execute FX transactions, and forecast liquidity across all currencies from one dashboard"
      }
    ],
    "Payments & Cards": [
      {
        title: "Wallet-as-a-Service",
        description: "Fast and reliable payment processing with support for multiple payment methods and currencies"
      },
      {
        title: "Card Issuing",
        description: "Comprehensive card management system with real-time controls and analytics"
      },
      {
        title: "Crypto Payments",
        description: "Automated settlement processes with full audit trail and compliance reporting"
      }
    ],
    "Compliance & Security": [
      {
        title: "KYC/KYB Tools",
        description: "Built-in compliance tools for regulatory requirements across multiple jurisdictions"
      },
      {
        title: "AML Compliance",
        description: "Enterprise-grade security with encryption, multi-factor authentication, and advanced threat detection"
      },
      {
        title: "AI Fraud Monitoring",
        description: "Comprehensive audit logs and compliance reporting for regulatory bodies"
      }
    ],
    "Client-Facing Products": [
      {
        title: "White-Label Bank Portal",
        description: "Native iOS and Android applications for seamless customer banking experiences"
      },
      {
        title: "Mobile Applications",
        description: "Responsive web application for full banking capabilities on desktop and tablet"
      },
      {
        title: "Crypto Wallets",
        description: "Powerful REST APIs for third-party integrations and custom applications"
      }
    ],
    "Pre-Built UI Library": [
      {
        title: "Design Tokens",
        description: "Customizable design tokens for consistent theming across all your applications"
      },
      {
        title: "Theme Builder",
        description: "Intuitive interface for creating and managing themes with real-time previews"
      },
      {
        title: "Dark & Light Modes",
        description: "Built-in support for dark and light modes, with automatic switching based on user preferences"
      }
    ]
  };

  const solutionModules: Record<string, { title: string; description: string }[]> = {
  "Traditional Finance": [
  ...
  "Digital Finance": [
    { title: "Fintech Startups", description: "Integrate credit products into any platform." },
    { title: "Neobanks & Challenger Banks", description: "Seamless checkout experiences for marketplaces." },
  ],
  "Payments": [
    { title: "Payment Service Providers(PSPs)", description: "Integrate credit products into any platform." },
  ...
  (() => {
    ...
    <div className="absolute top-full left-1/2 -translate-x-1/3 mt-2 w-[90vw] max-w-[1100px] bg-white shadow-2xl overflow-hidden z-50 flex flex-col">
      ...
      <div className="flex min-h-[350px]">
        ...
        {/* 3. Tightened Middle Content (p-10 -> p-6) */}
        <div className="flex-1 p-10 bg-white">
          <div className="grid grid-cols-2 gap-x-16 gap-y-12">
            {activeData[selectedModule]?.map((module, idx) => (
              <div key={idx}>
                <h3 className="text-base font-bold text-black mb-1 border-b border-blue-100 pb-0.5 inline-block">
                  {module.title}
                </h3>
        ...
        {/* 4. Scaled Right Sidebar (w-80 -> w-60) */}
