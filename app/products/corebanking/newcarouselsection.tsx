    ...
    <section className="bg-white py-10 md:py-24 text-white overflow-hidden">
      <div className="w-full pl-6 lg:pl-20">
        ...
        <div className="pr-6 lg:pr-20">
          <h2 className="md:text-start text-black text-3xl md:text-4xl font-bold mb-4">
            Who Is Core Banking Platform For? 
          </h2>
          <p className="mt-4 md:mt-6 md:text-start text-black mb-12 md:mb-16 mx-auto text-sm md:text-base">
            Fapshi was birthed from frustration with existing solutions in the market, so we know your pain. 
            Our APIs are straight to the point and well documented so that you can get started in minutes, not days. W
            e are constantly working on the solution to make it a joy to work with.
          </p>
        </div>
