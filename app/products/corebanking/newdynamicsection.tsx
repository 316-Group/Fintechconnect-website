...
export default function DynamicSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative w-full bg-slate-900 py-10 md:py-16 px-6 md:px-5 overflow-hidden min-h-[75vh] flex items-center"
    >
      ...
      */}
      ...
      <div className="relative z-10 max-w-full mx-auto px-1 md:px-16 w-full flex flex-col md:gap-24">
        ...
        <div className="max-w-2xl">
          <h2 
            className={`text-3xl md:text-4xl font-bold text-white tracking-tight leading-[1.15] mb-6 ${getAnimatedClass(isVisible)}`}
          ...
          >
            Instantly tap into leading gloabal coverage across currencies and markets, world class security, fast 
            onboarding, award winning customer support, and integrations with other popular platforms like Xero, Amazon, and Shopify.
          </p>
        </div>
