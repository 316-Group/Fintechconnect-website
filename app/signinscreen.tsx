...
const SignInScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-100 flex flex-col justify-between font-sans relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <svg
          ...
          fill="white"
        >
          <path d="M0,160L1440,0L1440,320L0,320Z"></path>
        </svg>
      </div>

      {/* Main Content Area - Wraps Logo and Card Together */}
      <main className="flex-grow flex flex-col items-center justify-center p-4 z-10 py-8">
        
        {/* Header / Logo directly on top of card */}
        ...
        <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-2xl shadow-xl shadow-slate-200/80 border border-slate-100">
          ...
          {/* Error Banner */}
          {error && (
            <div className="mb-6 p-3 rounded-lg bg-red-50 border border-red-200 text-red-600 text-sm font-light">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <div>
              ...
              <div>
                <input
                  ...
                  className="block w-full px-4 py-3 rounded-xl border border-slate-200/80 bg-blue-50/30 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all text-sm"
                  placeholder="enama"
                />
              </div>
            </div>

            {/* Password Field Header + Link */}
            <div>
            ...
            <div className="flex items-center pt-1">
              ...
              />
              <label htmlFor="remember-me" className="ml-2.5 block text-xs text-slate-600 cursor-pointer">
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-3.5 px-4 rounded-xl bg-blue-600 text-sm font-semibold text-white shadow-md shadow-blue-500/20 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-3 text-slate-400 font-light tracking-widest uppercase">
                OR
              </span>
            </div>
          </div>
          ...
          <div className="text-center space-y-2 text-xs text-slate-600 font-normal">
            <p>
              New to Fintech Connect?{' '}
      ...
      {/* Footer */}
      <footer className="w-full p-6 text-slate-500 text-xs z-10 flex flex-col sm:flex-row justify-between items-center gap-4 font-light">
        <div className="text-center sm:text-left">
          &copy; 2024 Fintech Connect. Institutional-grade infrastructure.
        </div>
        <div className="flex gap-6">
          <a href="#" className="hover:text-blue-600 transition-colors">Terms of Service</a>
          <a href="#" className="hover:text-blue-600 transition-colors">Privacy Policy</a>
          <a href="#" className="hover:text-blue-600 transition-colors">Developer Docs</a>
        </div>
      </footer>
