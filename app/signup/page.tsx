...
export default function SignUpPage() {
  ...
  // Simple strength rating returning 0 to 4 segments
  ...
  return (
    <div className="min-h-screen w-full bg-[#f4f7ff] flex flex-col justify-between items-center relative font-sans overflow-x-hidden">
      ...
      {/* Main Content Area */}
      <div className="z-10 w-full max-w-lg px-4 pt-10 pb-8 flex flex-col items-center my-auto">
        
        {/* Centered Brand Logo (Outside Card) */}
        ...
        {/* Form Card Container */}
        <div className="w-full bg-white rounded-xl shadow-xl shadow-blue-950/5 p-6 sm:p-10 border border-slate-100/80">
          
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">
            Create your account
          </h1>
          <p className="mt-1.5 text-sm text-slate-500 font-normal leading-relaxed">
            Start building institutional-grade financial infrastructure today.
          </p>
          ...
          <form onSubmit={handleSignUp} className="mt-6 space-y-4">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-1xl bg-[#f0f4fd] border border-transparent text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-blue-500 text-xs font-medium transition-all"
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 rounded-1xl bg-[#f0f4fd] border border-transparent text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-blue-500 text-xs font-medium transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="pt-3">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 px-4 rounded-xl bg-[#2f65ff] hover:bg-blue-700 text-xs font-semibold text-white shadow-lg shadow-blue-500/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <p className="mt-5 text-center text-xs text-slate-600 font-normal">
            Already have an account?{" "}
            <Link href="/signin" className="text-[#2f65ff] font-bold hover:underline">
              Sign In
            </Link>
          </p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-slate-500 font-normal max-w-sm leading-relaxed">
          ...
          <Link href="/terms" className="text-[#2f65ff] font-bold hover:underline">
            Terms of Service
          </Link>{" "}
          and{" "}
          <Link href="/privacy" className="text-[#2f65ff] font-bold hover:underline">
            Privacy Policy
          </Link>
          .
        </p>
