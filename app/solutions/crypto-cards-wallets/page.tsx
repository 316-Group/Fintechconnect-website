...
import ParallaxSection from "@/app/solutions/crypto-cards-wallets/parallaxsection";
import DynamicSection from "@/app/solutions/crypto-cards-wallets/dynamicsection";
import { Globe } from "@/components/ui/globe";
import Footersection from "@/app/Footersection";
import Newmodulessection from "@/app/solutions/crypto-cards-wallets/newmodulessection";
import BackgroundSection from "@/app/solutions/crypto-cards-wallets/backgroundsection";
import HoverSection from "@/app/solutions/crypto-cards-wallets/hoversection";
import NewfeaturesSection from "@/app/solutions/crypto-cards-wallets/newfeaturessection";
import Newpartnersection from "@/app/solutions/crypto-cards-wallets/newpartnersection";

export default function ForCryptoCardsWallets() {
    ...
    <div className="bg-blue-100 font-sans">
      ...
      <div ref={heroRef} className="pt-10 md:pt-12 w-full border-b-[5px] border-blue-600">
        ...
        <section className="md:text-center pl-6 md:pt-12 pb-12 px-4 max-w-5xl mx-auto">
          ...
          >
            Launch crypto wallets and cards your users <span className="text-blue-600">will actually use</span>
          </h1>
          ...
          >
           Fintech Connect gives wallet providers and card issuers the MPC wallet infrastructure, Visa/Mastercard card issuing, real-time crypto-to-fiat conversion, and AML compliance to launch a world-class crypto card product in weeks.
          </p>
        ...
        <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
          ...
          <div className="md:col-span-5">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Built for wallet providers <br></br> who want to bridge <br></br> crypto and everyday spending
            </h2>
          </div>
          ...
          <div className="md:col-span-7">
            <p className="text-slate-800 text-base md:text-2xl leading-relaxed font-normal">
              Fintech Connect delivers every layer of that stack through a single API, pre-certified and ready to deploy. 
              Launch your crypto wallet and card product in weeks, not years.
            </p>
          </div>
