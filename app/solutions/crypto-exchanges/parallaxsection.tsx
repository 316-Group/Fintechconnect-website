...
const struggles = [
  {
    id: 0,
    struggleTitle: "Wallet security and key management complexity",
    struggleDesc: "Hot wallets are a constant hacking target. Cold storage is too slow for everyday spending. Most wallet providers lack the MPC infrastructure to offer both security and instant access at scale.",
    solutionTitle: "Institutional-grade MPC security. Consumer-grade speed.",
    solutionDesc: "Fintech Connect MPC wallets eliminate the single point of key compromise that makes hot wallets vulnerable. Hot/warm/cold tiering gives your users instant access for everyday spending and maximum security for long-term holdings — without you building any custody infrastructure.",
    img: "/solutions/insurancecompanies/slide1.png"
  },
  {
    id: 1,
    struggleTitle: "Slow and expensive crypto-to-fiat conversion",
    struggleDesc: "Real-time conversion at point of sale requires deep FX infrastructure and banking relationships that most wallet providers do not have. High spreads and slow settlement drive users away.",
    solutionTitle: "Your users spend crypto. They see local currency. Instantly.",
    solutionDesc: "Fintech Connect handles real-time crypto-to-fiat conversion at point of sale — so your users tap their card and pay in GBP, EUR, or USD without thinking about it. Competitive mid-market FX rates, automated hedging, and same-day settlement make your card programme economically viable from day one.",
    img: "/solutions/creditunions/solution2.png"
  },
  {
    id: 2,
    struggleTitle: "Card issuing without a banking licence",
    struggleDesc: "Issuing Visa or Mastercard cards requires a principal membership or a BIN sponsor relationship — complex, expensive, and slow to establish. Most wallet providers get stuck here for 12+ months.",
    solutionTitle: "Skip the 12-month BIN sponsorship process.",
    solutionDesc: "Fintech Connect provides a pre-established card issuing infrastructure with Visa and Mastercard — so you can launch physical and virtual crypto debit cards in 4–8 weeks. Configurable spend controls, velocity limits, 3DS authentication, and cashback rewards are all included out of the box.",
    img: "/solutions/creditunions/solution3.png"
  },
  {
    id: 3,
    struggleTitle: "On-chain AML and chargeback fraud",
    struggleDesc: "Crypto card fraud and on-chain money laundering are existential risks for wallet providers. Without real-time AML screening and card fraud detection, a single incident can trigger card programme termination.",
    solutionTitle: "Protect your card programme from fraud and regulatory risk.",
    solutionDesc: "Real-time on-chain AML screening combined with AI-powered card fraud detection protects your wallet and card programme from both regulatory risk and financial loss. Automated 3DS challenges, velocity anomaly detection, and mixer screening keep your chargeback rate low and your card programme alive.",
