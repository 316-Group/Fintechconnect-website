...
import ParallaxSection from "@/app/solutions/crypto-web3/parallaxsection";
import DynamicSection from "@/app/solutions/crypto-web3/dynamicsection";
import { Globe } from "@/components/ui/globe";
import Footersection from "@/app/Footersection";
import Newmodulessection from "@/app/solutions/crypto-web3/newmodulessection";
import BackgroundSection from "@/app/solutions/crypto-web3/backgroundsection";
import HoverSection from "@/app/solutions/crypto-web3/hoversection";
import NewfeaturesSection from "@/app/solutions/crypto-web3/newfeaturessection";
import Newpartnersection from "@/app/solutions/crypto-web3/newpartnersection";

export default function ForCryptoWeb3() {
    ...
    <div className="bg-blue-100 font-sans">
      ...
      <div ref={heroRef} className="pt-10 md:pt-12 w-full border-b-[5px] border-blue-600">
        ...
        <section className="md:text-center pl-6 md:pt-12 pb-12 px-4 max-w-5xl mx-auto">
          ...
          >
            The banking infrastructure built for <span className="text-blue-600">the crypto-native era</span>
          </h1>
          ...
          >
           Fintech Connect gives crypto banks and Web3 financial institutions the compliant banking rails, MPC custody, fiat on/off ramps, and AML infrastructure to operate at the intersection of TradFi and DeFi.
          </p>
        ...
        <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
          ...
          <div className="md:col-span-5">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Built for institutions <br></br> operating at the intersection <br></br> of TradFi and DeFi
            </h2>
          </div>
          ...
          <div className="md:col-span-7">
            <p className="text-slate-800 text-base md:text-2xl leading-relaxed font-normal">
              From MPC custody and on-chain AML to fiat banking rails, card issuing, and KYC — 
              Fintech Connect gives crypto banks a single, 
              pre-certified infrastructure platform that satisfies regulators and delights users.
            </p>
          </div>
