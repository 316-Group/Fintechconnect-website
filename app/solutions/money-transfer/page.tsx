...
import ParallaxSection from "@/app/solutions/money-transfer/parallaxsection";
import DynamicSection from "@/app/solutions/money-transfer/dynamicsection";
import { Globe } from "@/components/ui/globe";
import Footersection from "@/app/Footersection";
import Newmodulessection from "@/app/solutions/money-transfer/newmodulessection";
import BackgroundSection from "@/app/solutions/money-transfer/backgroundsection";
import HoverSection from "@/app/solutions/money-transfer/hoversection";
import NewfeaturesSection from "@/app/solutions/money-transfer/newfeaturessection";
import Newpartnersection from "@/app/solutions/money-transfer/newpartnersection";
    ...
    <div className="bg-blue-100 font-sans">
      ...
      <div ref={heroRef} className="pt-10 md:pt-12 w-full border-b-[5px] border-blue-600">
        ...
        <section className="md:text-center pl-6 md:pt-12 pb-12 px-4 max-w-5xl mx-auto">
          ...
          >
           Fintech Connect gives money transfer operators the cross-border rails, FX engine, compliance infrastructure, and payout network to move money globally — fast, cheap, and fully compliant.
          </p>
        ...
        <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
          ...
          <div className="md:col-span-5">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Built to help money transfer <br></br> operators move faster <br></br> and cost less.
            </h2>
          </div>
          ...
          <div className="md:col-span-7">
            <p className="text-slate-800 text-base md:text-2xl leading-relaxed font-normal">
              Fintech Connect gives MTOs a modern infrastructure layer — real-time FX, pre-integrated payout networks (including mobile money), 
              automated AML/KYC, and a white-label consumer app — all deployable in weeks.
            </p>
          </div>
